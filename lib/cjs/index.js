...
Object.defineProperty(exports, "KiteState", { enumerable: true, get: function () { return constants_1.KiteState; } });
Object.defineProperty(exports, "KiteServerState", { enumerable: true, get: function () { return constants_1.KiteServerState; } });
Object.defineProperty(exports, "MAX_NUMBER_OF_BROKERS", { enumerable: true, get: function () { return constants_1.MAX_NUMBER_OF_BROKERS; } });
Object.defineProperty(exports, "MAX_NUMBER_OF_ZOOKEEPERS", { enumerable: true, get: function () { return constants_1.MAX_NUMBER_OF_ZOOKEEPERS; } });
const constants_2 = __importStar(require("./types/constants"));
exports.defaultCfg = constants_2.default;
Object.defineProperty(exports, "configFilePath", { enumerable: true, get: function () { return constants_2.configFilePath; } });
const getPorts_1 = require("./getPorts");
const ymlconstants_1 = require("./types/ymlconstants");
Object.defineProperty(exports, "_ports_", { enumerable: true, get: function () { return ymlconstants_1._ports_; } });
Object.defineProperty(exports, "downloadDir", { enumerable: true, get: function () { return ymlconstants_1.downloadDir; } });
const configPath = path_1.default.join(ymlconstants_1.downloadDir, 'docker-compose.yml');
const zipPath = path_1.default.join(ymlconstants_1.downloadDir, 'pipeline.zip');
...
function KiteCreator() {
    ...
    function checkConfigPorts(cfg) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                cfg.kafka = Object.assign(Object.assign({}, cfg.kafka), { brokers: Object.assign(Object.assign({}, cfg.kafka.brokers), { ports: Object.assign(Object.assign({}, cfg.kafka.brokers.ports), { brokers: yield checkPorts((_c = (_b = (_a = cfg.kafka.brokers) === null || _a === void 0 ? void 0 : _a.ports) === null || _b === void 0 ? void 0 : _b.brokers) !== null && _c !== void 0 ? _c : new Array(cfg.kafka.brokers.size).fill(ymlconstants_1._ports_.kafka.broker.external)), jmx: yield checkPorts((_f = (_e = (_d = cfg.kafka.brokers) === null || _d === void 0 ? void 0 : _d.ports) === null || _e === void 0 ? void 0 : _e.jmx) !== null && _f !== void 0 ? _f : new Array(cfg.kafka.brokers.size).fill(ymlconstants_1._ports_.kafka.jmx)) }) }), zookeepers: Object.assign(Object.assign({}, cfg.kafka.zookeepers), { ports: Object.assign(Object.assign({}, cfg.kafka.zookeepers.ports), { client: yield checkPorts((_j = (_h = (_g = cfg.kafka.zookeepers) === null || _g === void 0 ? void 0 : _g.ports) === null || _h === void 0 ? void 0 : _h.client) !== null && _j !== void 0 ? _j : new Array(cfg.kafka.zookeepers.size).fill(ymlconstants_1._ports_.zookeeper.client.external)) }) }) });
                if (cfg.kafka.jmx !== undefined) {
                    cfg.kafka.jmx = Object.assign(Object.assign({}, cfg.kafka.jmx), { ports: yield checkPorts((_k = cfg.kafka.jmx.ports) !== null && _k !== void 0 ? _k : new Array(cfg.kafka.zookeepers.size).fill(ymlconstants_1._ports_.jmx.external)) });
                }
                if (cfg.kafka.spring !== undefined) {
                    cfg.kafka.spring = Object.assign(Object.assign({}, cfg.kafka.spring), { port: yield checkPort((_l = cfg.kafka.spring.port) !== null && _l !== void 0 ? _l : ymlconstants_1._ports_.spring.external) });
                }
                if (cfg.db !== undefined) {
                    if (cfg.db.kafkaconnect !== undefined) {
                        cfg.db.kafkaconnect = Object.assign(Object.assign({}, cfg.db.kafkaconnect), { port: yield checkPort((_o = (_m = cfg.db.kafkaconnect) === null || _m === void 0 ? void 0 : _m.port) !== null && _o !== void 0 ? _o : ymlconstants_1._ports_.kafkaconnect_src.external) });
                    }
                    else {
                        cfg.db.kafkaconnect = {
                            port: yield checkPort(ymlconstants_1._ports_.kafkaconnect_src.external),
                        };
                    }
                    cfg.db = Object.assign(Object.assign({}, cfg.db), { port: yield checkPort((_p = cfg.db.port) !== null && _p !== void 0 ? _p : (cfg.db.name === 'ksql'
                            ? ymlconstants_1._ports_.ksql.external
                            : ymlconstants_1._ports_.postgresql.external)) });
                    if (cfg.db.ksql !== undefined) {
                        cfg.db.ksql = Object.assign(Object.assign({}, cfg.db.ksql), { schema_port: yield checkPort((_q = cfg.db.ksql.schema_port) !== null && _q !== void 0 ? _q : ymlconstants_1._ports_.ksql_schema.external) });
                    }
                }
                if (cfg.sink !== undefined) {
                    if (cfg.sink.kafkaconnect !== undefined) {
                        cfg.sink.kafkaconnect = Object.assign(Object.assign({}, cfg.sink.kafkaconnect), { port: yield checkPort((_r = cfg.sink.kafkaconnect.port) !== null && _r !== void 0 ? _r : ymlconstants_1._ports_.kafkaconnect_sink.external) });
                    }
                    else {
                        cfg.sink = Object.assign(Object.assign({}, cfg.sink), { kafkaconnect: {
                                port: yield checkPort(ymlconstants_1._ports_.kafkaconnect_sink.external),
                            } });
                    }
                    if (cfg.sink.name === 'jupyter') {
                        cfg.sink = Object.assign(Object.assign({}, cfg.sink), { port: yield checkPort((_t = (_s = cfg.sink) === null || _s === void 0 ? void 0 : _s.port) !== null && _t !== void 0 ? _t : ymlconstants_1._ports_.jupyter.external) });
                    }
                    else {
                        // spark
                        cfg.sink = Object.assign(Object.assign({}, cfg.sink), { port: yield checkPort((_v = (_u = cfg.sink) === null || _u === void 0 ? void 0 : _u.port) !== null && _v !== void 0 ? _v : ymlconstants_1._ports_.spark.webui.external), rpc_port: yield checkPort((_x = (_w = cfg.sink) === null || _w === void 0 ? void 0 : _w.rpc_port) !== null && _x !== void 0 ? _x : ymlconstants_1._ports_.spark.rpc.external) });
                    }
                }
                if (cfg.grafana !== undefined) {
                    cfg.grafana = Object.assign(Object.assign({}, cfg.grafana), { port: yield checkPort((_y = cfg.grafana.port) !== null && _y !== void 0 ? _y : ymlconstants_1._ports_.grafana.external) });
                }
                if (cfg.prometheus !== undefined) {
                    cfg.prometheus = Object.assign(Object.assign({}, cfg.prometheus), { port: yield checkPort((_z = cfg.prometheus.port) !== null && _z !== void 0 ? _z : ymlconstants_1._ports_.prometheus.external) });
                }
            }
            catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield docker_compose_1.default.upAll({
                    cwd: ymlconstants_1.downloadDir,
                    log: true,
    ...
    return {
        ...
        getPackageBuild: function () {
            ...
            zipper.sync.zip(ymlconstants_1.downloadDir).compress().save(zipPath);
