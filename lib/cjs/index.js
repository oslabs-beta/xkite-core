...
const downloadDir = path_1.default.join(process.cwd(), './download');
const configPath = path_1.default.join(downloadDir, 'docker-compose.yml');
const zipPath = path_1.default.join(downloadDir, 'pipeline.zip');
