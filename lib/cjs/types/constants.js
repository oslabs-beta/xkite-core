...
const ymlconstants_1 = require("./ymlconstants");
...
const defaultCfg = {
    kafka: {
        ...
        jmx: {
            ports: [ymlconstants_1._ports_.jmx.external, ymlconstants_1._ports_.jmx.external + 1],
        },
        spring: {
            port: ymlconstants_1._ports_.spring.external,
        },
    },
    db: {
        name: 'postgresql',
        port: ymlconstants_1._ports_.postgresql.external,
        kafkaconnect: { port: ymlconstants_1._ports_.kafkaconnect_src.external },
    },
    sink: {
        name: 'spark',
        port: ymlconstants_1._ports_.spark.webui.external,
        rpc_port: ymlconstants_1._ports_.spark.rpc.external,
        kafkaconnect: { port: ymlconstants_1._ports_.kafkaconnect_sink.external },
    },
    grafana: {
        port: ymlconstants_1._ports_.grafana.external,
    },
    prometheus: {
        scrape_interval: 5,
        evaluation_interval: 2,
        port: ymlconstants_1._ports_.prometheus.external,
    },
};
var KiteState;
(function (KiteState) {
