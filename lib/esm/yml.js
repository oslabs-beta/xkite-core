...
import os from 'os';
import { YAML, SPRING, SPARK, JUPYTER, KSQL_SCHEMA, KSQL_CLI, KSQL, POSTGRES, GRAFANA, PROMETHEUS, ZOOKEEPER, KAFKA_BROKER, JMX, PROMCONFIG, downloadDir, network, _ports_, KAFKA_CONNECT_SRC, KAFKA_CONNECT_SINK, } from './types/ymlconstants';
const dependencies = [];
const setup = {
    kafkaSetup: {
        clientId: '',
